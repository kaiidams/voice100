...
```sh
MODEL=ttsmultitask_en_conv_base

voice100-train-ttsmultitask \
  --gpus 1 \
  --dataset ${DATASET} \
  --language ${LANGUAGE} \
  --batch_size 32 \
...
- [English CMU TTS align](https://github.com/kaiidams/voice100/releases/download/v1.1.0/ttsalign_en_phone_conv_base-20220104.ckpt)
...
- [English CMU TTS multitask](https://github.com/kaiidams/voice100/releases/download/v1.2.0.pre1/ttsmultitask_en_conv_base-20220120.ckpt)
